...
public class WorldPopulationGrowth {
    ...
    private int newPercentageIncrease;
    public void calculateNewWorldPopulationGrowthRate(double currentGrowthRate, long currentWorldPopulation){
        int percentageIncrease = (int) (currentGrowthRate * currentWorldPopulation);
        newPopulation = currentWorldPopulation + percentageIncrease;
    }
    public long getWorldPopulationGrowthRate(){
        return newPopulation;
    }
    public void setPercentageIncrease(double currentGrowthRate,long currentWorldPopulation){
        newPercentageIncrease = (int) (currentGrowthRate * currentWorldPopulation);
    }
    public int getPercentageIncrease(){
        return newPercentageIncrease;
    }
}